...
<div class="cart_totals <?php if ( WC()->customer->has_calculated_shipping() ) echo 'calculated_shipping'; ?><?php echo $class; ?>">
	...
	<h2 class="widget-title"><span><?php esc_html_e( 'Cart Totals', 'estore' ); ?></span></h2>

	<table cellspacing="0" class="shop_table shop_table_responsive">

		<tr class="cart-subtotal">
			<th><?php esc_html_e( 'Subtotal', 'estore' ); ?></th>
			<td data-title="<?php esc_attr_e( 'Subtotal', 'estore' ); ?>"><?php wc_cart_totals_subtotal_html(); ?></td>
		</tr>
		...
		<?php elseif ( WC()->cart->needs_shipping() ) : ?>
			...
			<tr class="shipping">
				<th><?php esc_html_e( 'Shipping', 'estore' ); ?></th>
				<td data-title="<?php esc_attr_e( 'Shipping', 'estore' ); ?>"><?php woocommerce_shipping_calculator(); ?></td>
			</tr>
		...
		<tr class="order-total">
			<th><?php esc_html_e( 'Total', 'estore' ); ?></th>
			<td data-title="<?php esc_attr_e( 'Total', 'estore' ); ?>"><?php wc_cart_totals_order_total_html(); ?></td>
		</tr>
